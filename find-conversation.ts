...
async function findConversation() {
  ...
  // 輸出 API 調用命令
  console.log("\n📡 重新觸發通知的命令:");
  console.log(`curl -X POST https://sales-ai-server.salesaiautomationv3.workers.dev/rpc/conversations/analyze \\`);
  console.log(`  -H "Content-Type: application/json" \\`);
  console.log(`  -H "Authorization: Bearer 01cc199c38cd72f6acd34bc833384fda58afbf3b0d2f426b4ae0a7bf1415b33f" \\`);
